...
set output "uniq_end/scan/setup.nvp_wns.diff.png"
...
set ytics nomirror
set y2tics
plot "PREV/uniq_end/scan/setup.nvp_wns.dat" using 2:xticlabels(1) lc 0 axis x1y1  title "GOLDEN-1114/uniq_end-NVP", \
     "PREV/uniq_end/scan/setup.nvp_wns.dat" using 3:xticlabels(1) with linespoints lc 0 lw 1 pt 7 ps 1 axis x1y2  title "GOLDEN-1114/uniq_end-WNS", \
